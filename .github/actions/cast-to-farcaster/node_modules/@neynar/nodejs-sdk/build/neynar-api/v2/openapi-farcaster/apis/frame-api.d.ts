...
import { DeleteFrameResponse } from '@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster/models';
import { DeleteNeynarFrameRequest } from '@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster/models';
import { Frame } from '@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster/models';
import { FrameActionReqBody } from '@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster/models';
import { FrameValidateAnalyticsResponse } from '@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster/models';
import { FrameValidateListResponse } from '@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster/models';
import { NeynarFrame } from '@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster/models';
import { NeynarFrameCreationRequest } from '@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster/models';
import { NeynarFrameUpdateRequest } from '@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster/models';
import { ValidateFrameActionResponse } from '@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster/models';
import { ValidateFrameAnalyticsType } from '@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster/models';
import { ValidateFrameRequest } from '@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster/models';
/**
