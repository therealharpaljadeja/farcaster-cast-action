...
const convertToV2User = (v1User) => {
    var _a, _b;
    // @ts-ignore
    const v2User = Object.assign({ object: "user", fid: v1User.fid, custody_address: v1User.custodyAddress, username: v1User.username, display_name: v1User.displayName, pfp_url: v1User.pfp.url, profile: {
            bio: {
        ...
        }, follower_count: v1User === null || v1User === void 0 ? void 0 : v1User.followerCount, following_count: v1User === null || v1User === void 0 ? void 0 : v1User.followingCount, verifications: v1User === null || v1User === void 0 ? void 0 : v1User.verifications, verified_addresses: {
            eth_addresses: [],
            sol_addresses: [],
        }, active_status: (v1User === null || v1User === void 0 ? void 0 : v1User.activeStatus) === "active"
            ? v2_1.ActiveStatus.Active
            : v2_1.ActiveStatus.Inactive }, (v1User.viewerContext
        ? {
