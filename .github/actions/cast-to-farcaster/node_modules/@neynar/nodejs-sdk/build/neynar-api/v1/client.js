...
class NeynarV1APIClient {
    ...
    async fetchMentionAndReplyNotifications(fid, options) {
        const response = await this.apis.notifications.mentionsAndReplies(this.apiKey, fid, options === null || options === void 0 ? void 0 : options.viewerFid, options === null || options === void 0 ? void 0 : options.limit, options === null || options === void 0 ? void 0 : options.cursor);
        return response.data;
    }
    /**
