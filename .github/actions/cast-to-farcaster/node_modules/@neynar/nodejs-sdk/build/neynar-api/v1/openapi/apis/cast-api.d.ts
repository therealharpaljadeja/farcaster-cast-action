...
export declare const CastApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    allCastsInThread: (apiKey: string, threadHash: string, viewerFid?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    cast: (apiKey: string, hash: string, viewerFid?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    casts: (apiKey: string, fid: number, parentUrl?: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    recentCasts: (apiKey: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const CastApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    allCastsInThread(apiKey: string, threadHash: string, viewerFid?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AllCastsInThreadResponse>>;
    /**
     * Now deprecated, use [v2/cast](https://docs.neynar.com/reference/cast). Gets information about an individual cast
     * @summary DEPRECATED - Retrieve cast for a given hash
     * @param {string} apiKey API key required for authentication.
     ...
     * @throws {RequiredError}
     */
    cast(apiKey: string, hash: string, viewerFid?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastResponse>>;
    /**
     * Gets the most recent casts for a user
     * @summary Retrieve casts for a given user
     * @param {string} apiKey API key required for authentication.
     ...
     * @throws {RequiredError}
     */
    casts(apiKey: string, fid: number, parentUrl?: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastsResponse>>;
    /**
     * Get a list of casts from the protocol in reverse chronological order based on timestamp
     * @summary Get Recent Casts
     * @param {string} apiKey API key required for authentication.
     ...
     * @throws {RequiredError}
     */
    recentCasts(apiKey: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RecentCastsResponse>>;
};
/**
...
export declare class CastApi extends BaseAPI {
     ...
     * @memberof CastApi
     */
    allCastsInThread(apiKey: string, threadHash: string, viewerFid?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<AllCastsInThreadResponse, any>>;
    /**
     * Now deprecated, use [v2/cast](https://docs.neynar.com/reference/cast). Gets information about an individual cast
     * @summary DEPRECATED - Retrieve cast for a given hash
     * @param {string} apiKey API key required for authentication.
     ...
     * @memberof CastApi
     */
    cast(apiKey: string, hash: string, viewerFid?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CastResponse, any>>;
    /**
     * Gets the most recent casts for a user
     * @summary Retrieve casts for a given user
     * @param {string} apiKey API key required for authentication.
     ...
     * @memberof CastApi
     */
    casts(apiKey: string, fid: number, parentUrl?: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CastsResponse, any>>;
    /**
     * Get a list of casts from the protocol in reverse chronological order based on timestamp
     * @summary Get Recent Casts
     * @param {string} apiKey API key required for authentication.
     ...
     * @memberof CastApi
     */
    recentCasts(apiKey: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<RecentCastsResponse, any>>;
}
