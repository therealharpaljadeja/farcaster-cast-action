...
export declare const FollowsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    followers: (apiKey: string, fid: number, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    following: (apiKey: string, fid: number, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const FollowsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    followers(apiKey: string, fid: number, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FollowResponse>>;
    /**
     * Gets a list of users who is following a given user in reverse chronological order.
     * @summary Gets all following users of a FID
     * @param {string} apiKey API key required for authentication.
     ...
     * @throws {RequiredError}
     */
    following(apiKey: string, fid: number, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FollowResponse>>;
};
/**
...
export declare class FollowsApi extends BaseAPI {
     ...
     * @memberof FollowsApi
     */
    followers(apiKey: string, fid: number, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<FollowResponse, any>>;
    /**
     * Gets a list of users who is following a given user in reverse chronological order.
     * @summary Gets all following users of a FID
     * @param {string} apiKey API key required for authentication.
     ...
     * @memberof FollowsApi
     */
    following(apiKey: string, fid: number, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<FollowResponse, any>>;
}
