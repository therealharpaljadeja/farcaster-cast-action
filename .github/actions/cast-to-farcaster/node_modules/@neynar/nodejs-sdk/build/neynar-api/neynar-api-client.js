...
class NeynarAPIClient {
   ...
   */
    ...
    async lookUpCastByHashOrWarpcastUrl(castHashOrUrl, type) {
        return await this.clients.v2.lookUpCastByHashOrWarpcastUrl(castHashOrUrl, type);
    }
    /**
    ...
    async publishReactionToCast(signerUuid, reaction, castOrCastHash) {
        return await this.clients.v2.publishReactionToCast(signerUuid, reaction, castOrCastHash);
    }
    /**
