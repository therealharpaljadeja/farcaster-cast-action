...
import { VerificationResponse } from '@neynar/nodejs-sdk/build/neynar-api/v1/openapi/models';
/**
...
export declare const VerificationApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    userByVerification: (apiKey: string, address: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    verifications: (apiKey: string, fid: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const VerificationApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    userByVerification(apiKey: string, address: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserResponse>>;
    /**
     * Now deprecated, use [v2/user/bulk](https://docs.neynar.com/reference/user-bulk), verifications are in the user object. Get all known verifications of a user.
     * @summary DEPRECATED - Retrieve verifications for a given FID
     * @param {string} apiKey API key required for authentication.
     ...
     * @throws {RequiredError}
     */
    verifications(apiKey: string, fid: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VerificationResponse>>;
};
/**
...
export declare class VerificationApi extends BaseAPI {
     ...
     */
    userByVerification(apiKey: string, address: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<UserResponse, any>>;
    /**
     * Now deprecated, use [v2/user/bulk](https://docs.neynar.com/reference/user-bulk), verifications are in the user object. Get all known verifications of a user.
     * @summary DEPRECATED - Retrieve verifications for a given FID
     * @param {string} apiKey API key required for authentication.
     ...
     * @memberof VerificationApi
     */
    verifications(apiKey: string, fid: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<VerificationResponse, any>>;
}
