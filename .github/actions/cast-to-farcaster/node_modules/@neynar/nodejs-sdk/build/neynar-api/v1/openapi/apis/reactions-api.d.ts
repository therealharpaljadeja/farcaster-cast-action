...
export declare const ReactionsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    castLikes: (apiKey: string, castHash: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    castReactions: (apiKey: string, castHash: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    castRecasters: (apiKey: string, castHash: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const ReactionsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    castLikes(apiKey: string, castHash: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastLikesResponse>>;
    /**
     * Now deprecated, use [/v2/farcaster/reactions/cast](https://docs.neynar.com/reference/reactions-cast) - Get all reactions (likes and recasts) for a specific cast.
     * @summary DEPRECATED - Get all reactions for a specific cast
     * @param {string} apiKey API key required for authentication.
     ...
     * @throws {RequiredError}
     */
    castReactions(apiKey: string, castHash: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastReactionsResponse>>;
    /**
     * Now deprecated, use [/v2/farcaster/reactions/cast](https://docs.neynar.com/reference/reactions-cast) - Get all recasters for a specific cast.
     * @summary DEPRECATED - Get all recasters for a specific cast
     * @param {string} apiKey API key required for authentication.
     ...
     * @throws {RequiredError}
     */
    castRecasters(apiKey: string, castHash: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CastRecasterResponse>>;
};
/**
...
export declare class ReactionsApi extends BaseAPI {
     ...
     */
    castLikes(apiKey: string, castHash: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CastLikesResponse, any>>;
    /**
     * Now deprecated, use [/v2/farcaster/reactions/cast](https://docs.neynar.com/reference/reactions-cast) - Get all reactions (likes and recasts) for a specific cast.
     * @summary DEPRECATED - Get all reactions for a specific cast
     * @param {string} apiKey API key required for authentication.
     ...
     * @memberof ReactionsApi
     */
    castReactions(apiKey: string, castHash: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CastReactionsResponse, any>>;
    /**
     * Now deprecated, use [/v2/farcaster/reactions/cast](https://docs.neynar.com/reference/reactions-cast) - Get all recasters for a specific cast.
     * @summary DEPRECATED - Get all recasters for a specific cast
     * @param {string} apiKey API key required for authentication.
     ...
     * @memberof ReactionsApi
     */
    castRecasters(apiKey: string, castHash: string, viewerFid?: number, limit?: number, cursor?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CastRecasterResponse, any>>;
}
