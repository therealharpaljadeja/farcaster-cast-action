...
export declare class NeynarV2APIClient {
    ...
    */
     ...
     */
    getFreshAccountFID(): Promise<import("@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster").UserFIDResponse>;
    /**
     * This API is for Enterprise customers only. Please contact us if you want to try this out.
     *
    ...
    registerAccount(fid: number, signature: string, requested_user_custody_address: string, deadline: number, options?: {
        fname?: string;
    }): Promise<import("@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster").RegisterUserResponse>;
    /**
   ...
   */
    ...
    fetchUsersActiveChannels(fid: number, options?: {
        limit?: number;
        cursor?: string;
    }): Promise<import("@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster").UsersActiveChannelsResponse>;
    /**
     ...
     */
    lookupNeynarFrame(uuid: string): Promise<import("@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster").NeynarFrame>;
    /**
     ...
     */
    publishNeynarFrame(neynarFrameCreationRequest: NeynarFrameCreationRequest): Promise<import("@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster").NeynarFrame>;
    /**
     ...
     */
    updateNeynarFrame(neynarFrameUpdateRequest: NeynarFrameUpdateRequest): Promise<import("@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster").NeynarFrame>;
    /**
     ...
     */
    deleteNeynarFrame(uuid: string): Promise<import("@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster").DeleteFrameResponse>;
    /**
     ...
     */
    fetchNeynarFrames(): Promise<import("@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster").NeynarFrame[]>;
    /**
     ...
     */
    postFrameAction(signerUuid: string, castHash: string, action: FrameAction): Promise<import("@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster").Frame>;
    /**
