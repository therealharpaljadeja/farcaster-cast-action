 ...
 */
import { FrameValidateAnalyticsInteractionsPerCastInteractionsPerCastInner } from '@neynar/nodejs-sdk/build/neynar-api/v2/openapi-farcaster/models/frame-validate-analytics-interactions-per-cast-interactions-per-cast-inner';
/**
 *
 * @export
